from mocogan.models import Generator_I
import os
...
from mocogan.trainer import loadState
loadState(4, gen, path = trained_path)
...
dataset_path = os.path.join(current_path, 'TextToClass', 'data', 'dataset_Action_Description.txt')
...
#print(f'GammaFlow was trained on less categories, the video class that will be created is {actionClassName}')
